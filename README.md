...
I tried to recreate the feel and layout of the original Revolution menu as closely as the constraints of BO3 GSC allow. The menu is still actively updated — make sure to check the [Releases](https://github.com/a5x/BO3-PS4-Multiplayer-Mod-Menu-GSC/releases) section regularly for the latest version!
